...
public class PaymentServiceImpl implements PaymentService {
  ...
  @Override
  public Result<PaymentResponse> createAuthorize(
    ...
    while (true) {
      ...
      IdempotencyKey key =
          idempotencyKeyService.getOrCreateIdempotencyKey(
              merchantId, idempotencyKey, objectMapper.writeValueAsString(dto), operation);
      ...
      switch (key.getRecoveryPoint()) {
        case AuthorizeRecoveryPoints.STARTED -> {
          executor.execute(
              ...
              idempotencyKey,
              operation,
              k -> new AuthorizationContext(merchantId, k, dto),
        ...
        default ->
            throw new IllegalStateException("Unknown recovery point " + key.getRecoveryPoint());
      }
    }
  }
  ...
  private PhaseResult startAuthorization(AuthorizationContext context) {
    ...
    return new PhaseResult.RecoveryPoint(AuthorizeRecoveryPoints.AUTHORIZATION_CREATED);
  }
  ...
  private PhaseResult createAuthorization(AuthorizationContext context) {
    ...
    return new PhaseResult.RecoveryPoint(AuthorizeRecoveryPoints.BANK_AUTHORIZED);
  }
  ...
  private PhaseResult createBankAuthorization(AuthorizationContext context) {
    try {
      ...
      AuthorizeBankRequest request =
          new AuthorizeBankRequest(
              context.idempotencyKey().getPayment().getAmountMinor(),
              context.dto().cardDetails().cardNumber(),
              context.dto().cardDetails().cvv(),
              context.dto().cardDetails().expiryMonth(),
              context.dto().cardDetails().expiryYear());

      AuthorizeBankResponse response =
          bankClient.authorize(
              request, "authorization:" + context.idempotencyKey().getIdempotencyKey());

      Transaction transaction =
          new Transaction(
              context.idempotencyKey().getPayment(),
              response.amount(),
      ...
      return new PhaseResult.RecoveryPoint(AuthorizeRecoveryPoints.BANK_AUTHORIZATION_COMPLETED);
    } catch (BankBusinessException ex) {
      return new PhaseResult.Response<>(
          Result.failure(bankClient.mapBankErrrorToErrorCode(ex.getStatus()), ex.getMessage()));
    }
  }
  ...
  private PhaseResult completeBankAuthorization(AuthorizationContext context) {
    ...
    return new PhaseResult.RecoveryPoint(AuthorizeRecoveryPoints.FINISHED);
  }
  ...
  private PhaseResult finishAuthorization(AuthorizationContext context) {
    ...
    return new PhaseResult.Response<>(Result.success(paymentMapper.toDto(payment)));
  }

  @Override
  public Result<PaymentResponse> createCapture(
    ...
    while (true) {
      ...
      IdempotencyKey key =
          idempotencyKeyService.getOrCreateIdempotencyKey(
              ...
              idempotencyKey,
              paymentId,
              objectMapper.writeValueAsString(paymentId),
              operation);
      ...
      Transaction authorizationTransaction =
          transactionRepository
              .findByPaymentIdAndType(key.getPayment().getId(), TransactionType.AUTHORIZED)
  ...
  private PhaseResult startCapture(CaptureContext context) {
    ...
    return new PhaseResult.RecoveryPoint(CaptureRecoveryPoints.BANK_CAPTURE);
  }
  ...
  private PhaseResult createBankCapture(CaptureContext context) {
    try {
      ...
      CaptureBankRequest request =
          new CaptureBankRequest(context.amount(), context.authorizationRefId());

      CaptureBankResponse response =
          bankClient.capture(
              request,
              context.authorizationRefId() + ":" + context.idempotencyKey().getIdempotencyKey());
      ...
      return new PhaseResult.RecoveryPoint(CaptureRecoveryPoints.BANK_CAPTURE_COMPLETED);
    } catch (BankBusinessException ex) {
      return new PhaseResult.Response<>(
          Result.failure(bankClient.mapBankErrrorToErrorCode(ex.getStatus()), ex.getMessage()));
    }
  ...
  private PhaseResult completeBankCapture(CaptureContext context) {
    ...
    return new PhaseResult.RecoveryPoint(CaptureRecoveryPoints.FINISHED);
  }
  ...
  @Override
  public Result<PaymentResponse> createVoid(
      UUID paymentId, UUID merchantId, String idempotencyKey, Operation operation) {
    while (true) {
      IdempotencyKey key =
          idempotencyKeyService.getOrCreateIdempotencyKey(
      ...
      switch (key.getRecoveryPoint()) {
        case VoidRecoveryPoints.STARTED -> {
          executor.execute(
              ...
              idempotencyKey,
              operation,
              k -> new VoidContext(authorizationTransaction.getBankReference(), k),
              this::startVoid);
        }
  ...
  private PhaseResult startVoid(VoidContext context) {
    ...
    return new PhaseResult.RecoveryPoint(VoidRecoveryPoints.BANK_VOID);
  }
  ...
  private PhaseResult createBankVoid(VoidContext context) {
    ...
    try {
      ...
      return new PhaseResult.RecoveryPoint(VoidRecoveryPoints.BANK_VOID_COMPLETED);
    } catch (BankBusinessException ex) {
      return new PhaseResult.Response<>(
          Result.failure(bankClient.mapBankErrrorToErrorCode(ex.getStatus()), ex.getMessage()));
    }
  ...
  private PhaseResult completeBankVoid(VoidContext context) {
    ...
    return new PhaseResult.RecoveryPoint(VoidRecoveryPoints.FINISHED);
  }
  ...
  @Override
  public Result<PaymentResponse> createRefund(
      UUID paymentId, UUID merchantId, String idempotencyKey, Operation operation) {
    ...
    while (true) {
      ...
      Transaction authorizationTransaction =
          transactionRepository
              .findByPaymentIdAndType(key.getPayment().getId(), TransactionType.CAPTURE)
              .orElseThrow(() -> new ResourceNotFoundException("Transaction not found"));
      ...
      switch (key.getRecoveryPoint()) {
        case RefundRecoveryPoints.STARTED -> {
          executor.execute(
              ...
              idempotencyKey,
              operation,
              k -> new RefundContext(authorizationTransaction.getBankReference(), k),
              this::startRefund);
        }
  ...
  private PhaseResult startRefund(RefundContext context) {
    ...
    return new PhaseResult.RecoveryPoint(RefundRecoveryPoints.BANK_REFUND);
  }
  ...
  private PhaseResult createBankRefund(RefundContext context) {
    ...
    try {
      ...
      RefundBankRequest request =
          new RefundBankRequest(
              context.captureRefId(), context.idempotencyKey().getPayment().getAmountMinor());

      RefundBankResponse response =
          bankClient.refund(
              request, context.captureRefId() + ":" + context.idempotencyKey().getIdempotencyKey());
      ...
      return new PhaseResult.RecoveryPoint(RefundRecoveryPoints.BANK_REFUND_COMPLETED);
    } catch (BankBusinessException ex) {
      return new PhaseResult.Response<>(
          Result.failure(bankClient.mapBankErrrorToErrorCode(ex.getStatus()), ex.getMessage()));
    }
  ...
  private PhaseResult completeBankRefund(RefundContext context) {
    ...
    return new PhaseResult.RecoveryPoint(RefundRecoveryPoints.FINISHED);
  }
  ...
  public Result<PaymentResponse> getPayment(UUID paymentId, UUID merchantId) {
    Optional<Payment> payment =
        paymentRepository.findPaymentByIdAndMerchantId(paymentId, merchantId);
    return payment
        .map(value -> Result.success(paymentMapper.toDto(value)))
        .orElseGet(() -> Result.failure(ErrorCode.PAYMENT_NOT_FOUND, "Payment not found"));
  }
