...
public class PaymentController {
  ...
  public ResponseEntity<BaseResponse<PaymentResponse>> getPayment(
      @PathVariable UUID paymentId, @AuthenticationPrincipal MerchantPrincipal merchantPrincipal) {
    Result<PaymentResponse> paymentResponse =
        paymentService.getPayment(paymentId, merchantPrincipal.merchantId());
    return ResponseMapper.toResponse(paymentResponse);
  }
