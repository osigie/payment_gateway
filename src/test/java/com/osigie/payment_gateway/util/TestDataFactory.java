...
public class TestDataFactory {
    ...
    public static final UUID TEST_MERCHANT_ID = UUID.fromString("11111111-1111-1111-1111-111111111111");
    public static final UUID TEST_PAYMENT_ID = UUID.fromString("22222222-2222-2222-2222-222222222222");
    ...
    public static IdempotencyKey createIdempotencyKey(Merchant merchant, Payment payment, String recoveryPoint) {
        var key = new IdempotencyKey(merchant, TEST_IDEMPOTENCY_KEY, "{}", recoveryPoint, OffsetDateTime.now(), Operation.PAYMENT_AUTHORIZE);
        if (payment != null) {
    ...
    public static Transaction createTransaction(Payment payment, TransactionType type, String bankReference) {
        return new Transaction(payment, payment.getAmountMinor(), type, TransactionStatus.SUCCESS, bankReference);
    }
    ...
    public static CreateAuthorizationRequestDto createTestAuthorizationRequest() {
        return new CreateAuthorizationRequestDto("order-123", "cust-456", 5000L, createTestCardDetails());
    }
